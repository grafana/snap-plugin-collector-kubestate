...
var nodeCases = []struct {
...
}{
	{
		...
		expected: []string{
			...
			"grafanalabs.kubestate.node.default.127_0_0_1.status.allocatable.cpu.cores 3",
			"grafanalabs.kubestate.node.default.127_0_0_1.status.allocatable.memory.bytes 1e+09",
			"grafanalabs.kubestate.node.default.127_0_0_1.status.allocatable.pods 555",
		},
	},
}
